...
# create_clock -name {Clk_50} -period 20ns -waveform {0.000, 5.000} [get_ports MAX10_CLK1_50]
...
# set_input_delay -add_delay -max -clock clock_dram_ext 3.0 [get_ports SW*]
# set_input_delay -add_delay -min -clock clock_dram_ext 2.0 [get_ports SW*]
# set_input_delay -add_delay -max -clock clock_dram_ext 3.0 [get_ports KEY*]
# set_input_delay -add_delay -min -clock clock_dram_ext 2.0 [get_ports KEY*]
...
# set_output_delay -add_delay -max -clock clk_dram_ext 2.0 [get_ports LEDR*]
